import { WHATSAPP_HREF, cursosPresenciais, depoimentosPresenciais } from '@/data/cursosPresenciais'
...
export default function CursosPresenciaisSection() {
  return (
    <>
      <section id="presencial" className="py-20 bg-[#0a0a0a] scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="font-raleway text-xs tracking-[0.35em] uppercase text-[#c9a84c] mb-4">
              Cursos Presenciais
            </p>
            <h2 className="font-cormorant text-4xl sm:text-5xl text-white font-light leading-tight mb-4">
              Formação VIP com{' '}
              <em className="gradient-rose-gold not-italic">prática em modelo</em>
            </h2>
            <div className="gold-divider max-w-32 mx-auto mb-6" />
            <p className="font-raleway text-base text-white/78 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-16">
            {fotosCurso.map((foto) => (
              <div
                key={foto.src}
                className="aspect-square overflow-hidden border border-[#c9a84c]/15"
              >
                <img
                  src={foto.src}
                  alt={foto.alt}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10">
            <h2 className="font-cormorant text-3xl text-white font-light">
              Todos os cursos presenciais incluem
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-cormorant text-4xl text-white font-light">
              O que dizem nossas{' '}
              <em className="gradient-rose-gold not-italic">alunas presenciais</em>
            </h2>
            <div className="gold-divider max-w-32 mx-auto mt-6" />
          </div>

          <div className="grid grid-cols-3 gap-3 max-w-2xl mx-auto mb-12">
            {['/aluna1.jpeg', '/dupla_alunas.jpeg', '/aluna2.jpeg'].map((src) => (
              <div key={src} className="aspect-square overflow-hidden border border-[#c9a84c]/15">
                <img
                  src={src}
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {depoimentosPresenciais.map((d) => (
              <div
                key={d.nome}
                className="border border-white/8 bg-[#0f0f0f] p-6 flex flex-col gap-4"
              >
